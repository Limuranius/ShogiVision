...
# Form implementation generated from reading ui file 'ScanBook.ui'
#
...
class Ui_scan_book(object):
    def setupUi(self, scan_book):
        ...
        self.label_pdf_image = InteractiveImageLabel(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_pdf_image.sizePolicy().hasHeightForWidth())
        self.label_pdf_image.setSizePolicy(sizePolicy)
        self.label_pdf_image.setObjectName("label_pdf_image")
        self.verticalLayout_2.addWidget(self.label_pdf_image)
    ...
    def retranslateUi(self, scan_book):
        ...
        self.label_pdf_image.setText(_translate("scan_book", "PDF Image"))
